...
const SidebarTrigger = () => {
  ...
  return (
    <button
      ...
      className="p-xs text-primary-44 hover:text-primary-100 duration-short ease-curve-a scale-inline-100 cursor-pointer transition-colors"
      aria-label="切换导航侧边栏"
    >
...
const DesktopHeaderLeft = () => {
  ...
  return (
    <div
      ...
      className="hidden w-fit items-center gap-6 pointer-events-auto sm:flex"
    >
...
export function SiteHeader({
  ...
  return (
    <>
      {/* Mobile Logo Layer - Lower z-index to sit below Menu Overlay */}
      <div
        className={cn(
